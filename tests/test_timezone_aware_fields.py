...
from .models import CurrentDatetimeModelTest, DatetimeWithCompareModelTest


@override_settings(USE_TZ=True)
@pytest.mark.django_db
def test_datetime_fields_when_aware_db_and_naive_current_value():
    tm = DatetimeWithCompareModelTest.objects.create(datetime_field=datetime(2000, 1, 1, tzinfo=timezone.utc))
...
def test_datetime_fields_when_naive_db_and_aware_current_value():
    tm = DatetimeWithCompareModelTest.objects.create(datetime_field=datetime(2000, 1, 1))
...
def test_datetime_fields_when_aware_db_and_aware_current_value():
    ...
    tm = DatetimeWithCompareModelTest.objects.create(datetime_field=aware_dt)
...
def test_datetime_fields_when_naive_db_and_naive_current_value():
    ...
    tm = DatetimeWithCompareModelTest.objects.create(datetime_field=naive_dt)
